...
export const achievements: Achievement[] = [
  ...
  { title: '初试锋芒', description: '获得1000分', requirement: 1000, type: 'score' },
  { title: '成绩斐然', description: '获得2000分', requirement: 2000, type: 'score' },
  { title: '登峰造极', description: '获得5000分', requirement: 5000, type: 'score' },
  { title: '超凡入圣', description: '获得10000分', requirement: 10000, type: 'score' },
];
